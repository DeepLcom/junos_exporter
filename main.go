...
var (
	...
	systemstatisticsUDPEnabled  = flag.Bool("systemstatisticsudp.enabled", true, "Scrape system statistics UDP metrics")
	cfg                         *config.Config
...
func loadConfigFromFlags() *config.Config {
	...
	f.SystemStatisticsUDP = *systemstatisticsUDPEnabled
	return c
}
