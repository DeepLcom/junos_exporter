...
import (
	...
	"github.com/czerwonk/junos_exporter/pkg/features/systemstatistics/systemstatisticsUDP"
...
func (c *collectors) initCollectorsForDevices(device *connector.Device, descRe *regexp.Regexp) {
	...
	c.addCollectorIfEnabledForDevice(device, "system_statistics_udp", f.SystemStatisticsUDP, systemstatisticsUDP.NewCollector)
}
